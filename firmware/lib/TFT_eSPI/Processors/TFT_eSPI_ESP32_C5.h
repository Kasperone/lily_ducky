...
// Fix IDF problems with ESP32C5 (copied from the C3 file — same GPSPI2
// layout and IDF5 register names; validated on real C5 hardware, see
// Bodmer/TFT_eSPI#3751)
#if CONFIG_IDF_TARGET_ESP32C5
  // Fix missing definition (VSPI/FSPI only tested at the moment)
  #ifndef REG_SPI_BASE
    #define REG_SPI_BASE(i) DR_REG_SPI2_BASE
  #endif

  // IDF5 renamed SPI_MOSI_DLEN_REG to SPI_MS_DLEN_REG
...
ESP32 C3 / C5: Only 1 SPI port available (GPSPI2)
FSPI = 1, uses SPI2
HSPI = 1, uses SPI2
VSPI not defined so have made VSPI = HSPI
...
// ESP32 specific SPI port selection - only SPI2_HOST available on C5
